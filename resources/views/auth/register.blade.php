    ...
    <main>
      <section class="relative w-full h-full py-40 min-h-screen">
        <div
          ...
          style="background-image: url({{asset('template/assets/img/register_bg_2.png')}})"
        ></div>
                  ...
                  <div class="btn-wrapper text-center">
                    ...
                    >
                      <img
                        alt="..."
                        class="w-5 mr-1"
                        src="{{asset('template/assets/img/github.svg')}}"
                      />
                      Github
                    </button>
                    <button
                    ...
                    >
                      <img
                        alt="..."
                        class="w-5 mr-1"
                        src="{{asset('template/assets/img/google.svg')}}"
                      />
                      Google
                    </button>
                  </div>
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                  ...
                  <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="relative w-full mb-3">
                      ...
                      <input
                        type="password" type="password" name="password_confirmation" required autocomplete="new-password"
                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
