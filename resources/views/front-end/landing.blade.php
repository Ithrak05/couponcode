...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="{{asset('template/assets/img/favicon.ico')}}" />
    <link
    ...
    <link
      rel="stylesheet"
      href="{{asset('template/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css')}}"
    />
    <link rel="stylesheet" href="{{asset('template/assets/styles/tailwind.css')}}" />
      ...
      <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        >
          ...
          >
            ...
            @auth
            <li class="flex items-center">
                <a  href="{{ route('user.couponcode.index')}}"class="bg-white text-blueGray-700 active:bg-blueGray-50 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150">
                  Dashboard
                </a>
            </li>
            @else
            <li class="flex items-center">
                <a  href="{{ route('login') }}"class="bg-white text-blueGray-700 active:bg-blueGray-50 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150">
                  Login
                </a>
            </li>
            <li class="flex items-center">
                <a  href="{{ route('register') }}"class="bg-white text-blueGray-700 active:bg-blueGray-50 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150">
                  Register
                </a>
            </li>
            @endauth
