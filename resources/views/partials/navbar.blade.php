<nav class="absolute bg-pink-600 top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
    <div
          ...
          <div class="items-center flex">
            <span
              ...
              ><img
                ...
                src="{{asset('template/assets/img/team-1-800x800.jpg')}}"
            /></span>
          </div>
        </a>
        <div
